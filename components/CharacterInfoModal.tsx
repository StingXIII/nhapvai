...
import StatsDisplay from './common/StatsDisplay'; // Import the new component
...
const InformationModal: React.FC<InformationModalProps> = ({ isOpen, onClose, gameState, onDeleteEntity }) => {
  ...
  const { character, inventory, playerStats } = gameState; // Destructure playerStats
        ...
        <div className="flex-grow overflow-y-auto p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
              <div className="space-y-6">
                ...
                {gameState.worldConfig.enableStatsSystem && playerStats && (
                  <div>
                    <StatsDisplay stats={playerStats} title="Chỉ Số Cơ Bản" />
                  </div>
                )}
