...
const DebugScreen: React.FC<DebugScreenProps> = ({ onBack }) => {
  ...
  const generateDebugCombatState = (): GameState => {
    ...
    const createDebugNPC = (id: string, name: string, type: 'ally' | 'enemy'): NPC => ({
        ...
        // FIX: Add missing 'affinity' property to satisfy the EncounteredNPC type.
  ...
  const generateDebugCultivationState = (): GameState => {
      ...
      const partner: Wife = {
          ...
          affinity: 100,
          // FIX: Add missing properties 'entityType', 'obedience', and 'willpower' to satisfy the Wife type.
          entityType: 'wife',
          obedience: 50,
          willpower: 100,
          memoryFlags: {},
